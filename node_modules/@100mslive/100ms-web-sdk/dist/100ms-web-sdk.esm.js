...
var NotificationManager = /*#__PURE__*/function (_EventTarget) {
  ...
  function NotificationManager() {
    ...
    _this.handleOnTrackRemove = function (track) {
      ...
      if (hmsPeer) {
        ...
        track.type === HMSTrackType.AUDIO && _this.dispatchEvent(new CustomEvent('track-removed', {
          detail: track
        }));

        _this.listener.onTrackUpdate(HMSTrackUpdate.TRACK_REMOVED, track, hmsPeer);
      }
    };
      ...
      for (var _i = 0, _Object$entries = Object.entries(params.tracks); _i < _Object$entries.length; _i++) {
        ...
        if (!track || _this.tracksToProcess.has(trackId)) {
          ...
          if (currentTrackStateInfo.mute !== trackEntry.mute) {
            if (trackEntry.mute) {
              _this.listener.onTrackUpdate(HMSTrackUpdate.TRACK_MUTED, track, hmsPeer);
            } else {
              _this.listener.onTrackUpdate(HMSTrackUpdate.TRACK_UNMUTED, track, hmsPeer);
            }
          } else if (currentTrackStateInfo.description !== trackEntry.description) {
            _this.listener.onTrackUpdate(HMSTrackUpdate.TRACK_DESCRIPTION_CHANGED, track, hmsPeer);
          }
        }
      }
    };
  ...
  _proto.processPendingTracks = function processPendingTracks() {
    ...
    tracksCopy.forEach(function (track) {
      ...
      track.type === HMSTrackType.AUDIO && _this2.dispatchEvent(new CustomEvent('track-added', {
        detail: track
      }));

      _this2.listener.onTrackUpdate(HMSTrackUpdate.TRACK_ADDED, track, hmsPeer);
...
var HMSAudioSinkManager = /*#__PURE__*/function () {
  ...
  _proto.addSilentAudio = function addSilentAudio() {
    ...
    silentAudio.id = "HMS-SDK-silent-audio-track-" + v4();
      ...
      case HMSNotificationMethod.PEER_JOIN:
        {
          ...
          hmsPeer ? this.listener.onPeerUpdate(HMSPeerUpdate.PEER_JOINED, hmsPeer) : HMSLogger.e(this.TAG, "\u26A0\uFE0F peer not found in peer-list", peer, this.notificationManager.hmsPeerList);
          break;
        }
      ...
      case HMSNotificationMethod.PEER_LEAVE:
        {
          ...
          if (_hmsPeer.audioTrack) {
            ...
            (_this$listener2 = this.listener) == null ? void 0 : _this$listener2.onTrackUpdate(HMSTrackUpdate.TRACK_REMOVED, _hmsPeer.audioTrack, _hmsPeer);
          }

          if (_hmsPeer.videoTrack) {
            var _this$listener3;

            (_this$listener3 = this.listener) == null ? void 0 : _this$listener3.onTrackUpdate(HMSTrackUpdate.TRACK_REMOVED, _hmsPeer.videoTrack, _hmsPeer);
          }

          (_hmsPeer$auxiliaryTra = _hmsPeer.auxiliaryTracks) == null ? void 0 : _hmsPeer$auxiliaryTra.forEach(function (track) {
            var _this4$listener;

            (_this4$listener = _this4.listener) == null ? void 0 : _this4$listener.onTrackUpdate(HMSTrackUpdate.TRACK_REMOVED, track, _hmsPeer);
          });
          (_this$listener4 = this.listener) == null ? void 0 : _this$listener4.onPeerUpdate(HMSPeerUpdate.PEER_LEFT, _hmsPeer);
          break;
        }
                        ...
                        while (1) {
                          switch (_context5.prev = _context5.next) {
                            case 0:
                              ...
                              _context5.next = _context5.t0 === HMSTrackType.AUDIO ? 3 : _context5.t0 === HMSTrackType.VIDEO ? 5 : 7;
                              break;
                            ...
                            case 15:
                              (_this5$listener = _this5.listener) == null ? void 0 : _this5$listener.onTrackUpdate(HMSTrackUpdate.TRACK_ADDED, hmsTrack, _this5.localPeer);
...
export { HMSPeerUpdate, HMSRoomUpdate, HMSSdk, HMSTrackType, HMSTrackUpdate, getLocalDevices, getLocalScreen, getLocalStream };
//# sourceMappingURL=100ms-web-sdk.esm.js.map
